...
<body>
	<div id="wrapper">
		<div id='mainbar'>
			<h1 id="greeting">Chat with your gift recipient (they don't know who you are)</h1>
			<div id="chatbox">
				<div id="chatarea">
	...
	<div id='sidebar'>
		...
		<a class="tab current" href="recipient.php">
	...
	<script>
		...
		$(document).keypress(function(e) {
		    if(e.which == 13) {
	            ...
	            $("#message").val('');
				$.ajax({
			        url: "http://hwsanta.com/app/home/messagerecipient.php?userid="+userid+"&message="+message,
			        type: "post",
			        dataType: 'json',
		...
		function refresh(){
			...
			$.ajax({
		        url: "http://hwsanta.com/app/home/chatrecipient.php?userid="+userid,
		        type: "post",
		        dataType: 'json',
		        // callback handler that will be called on success
		        success: function(response, textStatus, jqXHR){
